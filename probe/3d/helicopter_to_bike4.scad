...
circleThickness = 1;
radius = 3.8;
excess_rotation = -36-(80);


// arms
   
color("DarkGray")
translate([0.6-(5.5*$t),-1*$t,6-(1*$t)])
rotate([0-(40*$t),0,90])
cube([0.8-(0.2*$t),15-(2*$t),0.6],center=true);

color("DarkGray")
translate([0.6+(4.5*$t),-1*$t,6-(1*$t)])
rotate([0+(40*$t),0,90])
cube([0.8,15-(2*$t),0.6],center=true);

color("DarkGray")
translate([0.6,0,6-(5*$t)])
rotate([0,0,90])
...
rotate([0,0,-90*$t])
color("DarkGray")
translate([-4.25,(6)*sin(360),4+(7.8)])
rotate([0,90,90+(360)])
translate([0,-4.2,0])
...
// black smarties
// seat
translate([0,0,11-(2*$t)])
rotate([90*$t,0,0])
color("black")
scale([1,1,0.15])
sphere(radius,$fn=40);

translate([7.5*$t,0,11-(10*$t)])
rotate([90*$t,0,0])
color("black")
scale([1,1,0.15])
sphere(radius,$fn=40);
