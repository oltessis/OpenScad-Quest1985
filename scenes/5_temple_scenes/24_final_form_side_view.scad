...
$vpt = [8.28, 536, 50];   // camera position
$vpr = [80, 0.00, 54];    // rotation
$vpd = 57.55;               // distance from camera
$vpf = 65;                 // field of view (perspective only)
...
translate([0,491.2-2+25+(22*$t), 38.5-28.5+17.4])
rotate([0, 90-90, -90+90])
scale(0.42)
end_form();

translate([0,491.2-2+25+(22*$t), 38.5-28.5+3])
rotate([0, 90+90, -90+90])
scale(0.42)
end_form();
