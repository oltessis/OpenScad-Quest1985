...
$vpt = [0, 520.8, 31.5];   // camera position
$vpr = [90, 0.00, 180];    // rotation
$vpd = 43.3;               // distance from camera
$vpf = 53;                 // field of view (perspective only)
...
translate([0,491.2-2+25+(24*$t), 38.5-28.5+17.4])
rotate([0, 90-90, -90+90])
scale(0.42)
end_form();

translate([0,491.2-2+25+(24*$t), 38.5-28.5+3])
rotate([0, 90+90, -90+90])
scale(0.42)
end_form();
