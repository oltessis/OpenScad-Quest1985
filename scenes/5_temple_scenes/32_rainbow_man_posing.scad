...
//include <rainbow_man_transition1.scad>
//include <rainbow_man_transition1_2.scad>
//include <end_form_to_rainbow_man.scad>
include <rainbow_man.scad>


// 15-20 columns deep


$vpt = [0, 530, 38];   // camera position
$vpr = [98, 0, 180];    // rotation
$vpd = 60;               // distance from camera
$vpf = 45;                 // field of view (perspective only)


//$vpf = 24;                   // field of view (perspective only)




translate([0,491.2-2+25+(22)-10.5+5+(19)+(2*$t), 38.5-28.5+17.4+6-(1)])
