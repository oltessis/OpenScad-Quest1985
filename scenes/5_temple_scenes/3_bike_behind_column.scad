...
translate([6-(6*pow($t,3)), 136+(8*pow($t,0.3)), 21])
rotate([0+(12*(1-cos(360*$t))/2), 0, 90+(36*$t)])
scale(0.48)
bike_animation();

translate([6-(6*pow($t,3)), 136+(8*pow($t,0.3)), 18])
rotate([180-(12*(1-cos(360*$t))/2), 0, 90+(36*$t)])
scale(0.48)
bike_animation();
