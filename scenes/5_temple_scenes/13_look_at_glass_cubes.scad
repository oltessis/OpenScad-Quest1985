...
include <slinky_looking_head.scad>
...
$vpt = [-0.8, 570, 33.5];   // camera position
$vpr = [87, 0.00, 0.0];    // rotation
$vpd = 105.76;                  // distance from camera
$vpf = 39.5-(35*$t);                   // field of view (perspective only)


// slinky's might be sitting one unit too low
translate([-1.2,410+(18*$t), 28.7])
translate([0,0,5])
rotate([180, 3, -67])
scale(0.48)
slinky();
