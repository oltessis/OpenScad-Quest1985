...
/*
$vpt = [0.75, 309.37, 32.29];   // camera position
$vpr = [94.9, 0.00, 179.7];    // rotation
$vpd = 19.43;                  // distance from camera
$vpf = 45;                   // field of view (perspective only)
*/

translate([6-(6)-(8*$t), 136+(8)+(10*$t), 21])
rotate([0, 0, 90+(36)-(36*$t)])
scale(0.48)
bike_animation();

translate([6-(6)-(8*$t), 136+(8)+(10*$t), 18])
rotate([180, 0, 90+(36)-(36*$t)])
scale(0.48)
bike_animation();
