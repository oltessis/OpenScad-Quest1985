...
$vpt = [14.91, 524.53, 42.47];   // camera position
$vpr = [76.7, 0.00, 103];    // rotation
$vpd = 78;                  // distance from camera
$vpf = 55;                   // field of view (perspective only)
...
/*
translate([0,488.8+(2.4*$t), 39-(0.5*$t)])
rotate([0, 50+(40*$t), -90])
scale(0.48)
slinky2();
*/
...
/*
translate([0,491.2, 38.5-7])
rotate([0, 90, -90+180])
//scale(0.48)
scale(0.42)
slinky_s();

translate([0,491.2, 38.5-28.5])
rotate([0, 90+180, -90+180])
//scale(0.48)
scale(0.42)
slinky_s();
*/

translate([0,491.2-2+(25*$t), 38.5-28.5+17.4])
rotate([0, 90-90, -90+90])
scale(0.42)
end_form();

translate([0,491.2-2+(25*$t), 38.5-28.5+3])
rotate([0, 90+90, -90+90])
scale(0.42)
end_form();
...
scale(2.5)
for (i = [180:22.5:360]) {
 rotate([0,0,i-1.8+col_correction2])
 translate([0,32.5,-0.5])
 temple_sanctum_column();
}
scale(2.5)
for (i = [0:22.5:360]) {
 rotate([0,0,i+12.25+col_correction-2.95])
