...
$vpt = [-14.00-(11), -5.95+(14), -6.99];   // camera position
$vpr = [68.3, 0, 105.1];    // rotation
$vpd = 78.86;                  // distance from camera
$vpf = 22;                   // field of view (perspective only)


translate([10-(8)-(0.8*$t),-2+(16)+(1*$t),-2+(4)+(1*$t)])
rotate([0+90,4+30+(50*$t),180-100+(30)-(360+(180))])
scale(0.1)
fish();
