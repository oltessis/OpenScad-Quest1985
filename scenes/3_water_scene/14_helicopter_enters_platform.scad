...
//include <fish.scad>
include <fish_to_helicopter.scad>
//include <fish_fins_closing.scad>
include <helicopter.scad>



$vpt = [5, 880, 147+(4*$t)];   // camera position
$vpr = [100, 0, 18.2];    // rotation
$vpd = 15;                  // distance from camera
$vpf = 40;                   // field of view (perspective only)


translate([-1, 885+(10*$t), 138+(14*$t)])
rotate([0, 0, 30-((360*2.5)*$t)])
scale(0.1)
helicopter();
