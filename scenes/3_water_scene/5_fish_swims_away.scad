...
$vpr = [85+(2*$t), 0, 351];    // rotation
$vpd = 70-(8*$t);                  // distance from camera
$vpf = 22+(10*$t);                   // field of view (perspective only)


translate([-13+(1.5)-(12*$t),-70-4+(50*$t),1+(0.5)])
rotate([0+90,4,-100+(30)])
scale(0.1)
fish();
