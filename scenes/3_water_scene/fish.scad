...
module fish() {
    ...
    color("DarkGray")
    translate([12,0,(-1*sin(sin_cycle*$t))])
    rotate([(8*sin(sin_cycle*$t)),0,90])
    cube([0.8,16,0.6],center=true);
    color("DarkGray")
    translate([12,-8*sin(20),(-1*sin(sin_cycle*$t))])
    rotate([(8*sin(sin_cycle*$t)),0,90-20])
    cube([0.8,16,0.6],center=true);
    color("DarkGray")
    translate([12,8*sin(20),(-1*sin(sin_cycle*$t))])
    rotate([(8*sin(sin_cycle*$t)),0,90+20])
