...
include <game_board_no_top.scad>
...
translate(pivot_point)
rotate([0,0,270])
translate([probe_distance-7-6-11-9-6-(10.2*$t),0,-1])
scale(probe_scale)
rotate([0,0,-85+85])
_2dprobe3();
...
$vpt = [0, 4+(10*$t), 20.02];   // camera position
$vpr = [85, 0.00, 0];    // rotation
$vpd = 183.63;                  // distance from camera
