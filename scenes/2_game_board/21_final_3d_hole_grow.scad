...
include <game_board_grow_hole.scad>
...
// probe ring 
pivot_point = [0,-31,27]; 
rotate_index = 531+(20*$t); // 15 deg per cycle
rotate_step = 22.5;
probe1_factor = 5;
probe_scale = 0.6;
probe_distance = 57;
...
$vpt = [-3-(7.47*$t), -137.54-(1*$t), -7.78+(0.6*$t)];   // camera position
$vpr = [0+(4.2*$t), 0.00, 90];    // rotation
$vpd = 83+(55*$t);                  // distance from camera
