...
// probe ring 
pivot_point = [0,-31,27]; 
rotate_index = 357 + (15*$t); // 15 deg per cycle
rotate_step = 22.5;
probe1_factor = 5;
probe_scale = 0.6;
probe_distance = 57;
...
translate(pivot_point)
rotate([0,0,450])
translate([probe_distance -6 - (42*$t),0,0])
scale(probe_scale)
rotate([0,0,180+(90)])
_2dprobe1();
...
$vpt = [24.08, -94.33-(32*$t), 48.56];   // camera position
$vpr = [81.60, 0.00, 78.40 + (19*$t)];    // rotation
$vpd = 113.10;                  // distance from camera
