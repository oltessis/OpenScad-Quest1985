...
// probe ring 
pivot_point = [0,-31,27]; 
rotate_index = 501+(22*$t); // 15 deg per cycle
rotate_step = 22.5;
probe1_factor = 5;
probe_scale = 0.6;
probe_distance = 57;
...
translate(pivot_point)
rotate([0,0,270])
translate([probe_distance-7-6-11-(9*$t),0,0])
scale(probe_scale)
rotate([0,0,-85+85])
_2dprobe3();
...
$vpt = [0, -220, 33.7];   // camera position
$vpr = [82, 0.00, 180];    // rotation
$vpd = 241.7;                  // distance from camera
