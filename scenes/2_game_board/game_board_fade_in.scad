...
color("#3A3A3A",$t)
difference(){
translate([0,234-(250),0])
cube([1000,1700,1],center=true);
translate([0,546,0])
...
difference() {
difference() {
    cylinder(0.1, r1=72, r2=72, $fn=200,center=true);
    cylinder(0.2, r1=70, r2=70, $fn=200,center=true);
}
cube([25,150,1],center=true);
}
translate([0,545,2])
difference(){
difference() {
    cylinder(0.1, r1=45, r2=45, $fn=200,center=true);
    cylinder(0.2, r1=43, r2=43, $fn=200,center=true);
}
...
union(){
difference() {
    cylinder(0.1, 9, 9, $fn=15,center=true);
    cylinder(0.2, 7.6, 7.6, $fn=15,center=true);
}
