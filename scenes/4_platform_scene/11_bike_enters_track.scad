...
$vpt = [53.77, -320, 10];   // camera position
$vpr = [78.4, 0, 187.9];    // rotation
$vpd = 205;                  // distance from camera
$vpf = 40;                   // field of view (perspective only)


translate([52+(40*$t),-300+(50*$t),0+(2.5)+1])
scale(0.8)
rotate([0,0,21+(69*$t)])
bike_animation();
