...
$vpt = [19.08, -334.57, 13.78];   // camera position
$vpr = [88, 0, 176];    // rotation
$vpd = 106;                  // distance from camera
$vpf = 26;                   // field of view (perspective only)


translate([22+(30*$t),-350+(10)+(15*$t),0+(2.5)+1])
scale(0.8)
rotate([0,0,201+180])
bike_animation();
